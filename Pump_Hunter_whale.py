...
EARLY_ACCUMULATION_HOURS = 3          
EARLY_MIN_RVOL = 1.08                 
EARLY_OI_CHANGE_MIN = 0.08            
MAX_COMPRESSION_ATR_PCT = 0.008       # Сжатие волатильности (до 0.8%)
IMPULSE_BODY_MULT = 2.5               # Тело свечи в 2.5 раза больше среднего
IMPULSE_VOL_MULT = 2.0                # Объём в 2.0 раза больше среднего

# ===== НАСТРОЙКИ МОДУЛЯ 2: PRE-BREAKOUT ⚡ =====
TIMEFRAME_SMALL = "5m"
TIMEFRAME_BIG = "1h"
PRE_BREAKOUT_DIST_PCT = 2.5           
MIN_HARD_RVOL = 1.1                   
MIN_SCORE_TO_SEND = 35                

# ===== НАСТРОЙКИ МОДУЛЯ 3: ROCKET 🚀 =====
ROCKET_RVOL_THRESHOLD = 2.5           
ROCKET_PRICE_CHANGE_PCT = 2.5         

# Защита от спама и память
SIGNAL_COOLDOWN = 1200                # 20 минут КД
last_signals = {}
oi_history = {}                       
...
# ===== МОДУЛЬ 1: EARLY BOTTOM DETECTOR =====
...
async def main():
    ...
    # 🧪 Авто-прогон бэктеста при старте
    try:
        await run_history_backtest(bot, test_symbols=["UB-USDT", "COTI-USDT", "ONUS-USDT"])
    except Exception as e:
        logging.error(f"Ошибка выполнения бэктеста: {e}")
